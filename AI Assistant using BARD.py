...
token2 = 'sidts-CjIBNiGH7mkydGmlZ66ysoi7W-O3xqWuUTxUWuTMdyX937_0dhkEVh7CJ09UgRAObNwTqxAA'
...
def send_prompt():
    ...
    response_ = chatbot.ask(prompt)
    speak_text = response_['content']
    response.delete('1.0', 'end')
    response.insert('1.0', response_['content'])
    root.update()
